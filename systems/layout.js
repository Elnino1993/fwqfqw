...
const getWidth = (container) =>
  container.width ? container.width : container.clientWidth ? container.containerWidth : container.innerWidth
const getHeight = (container) =>
  container.height ? container.height : container.clientHeight ? container.containerHeight : container.innerHeight

const LayoutSystem = (entities, { window }) => {
  const entitiesToMove = Object.values(entities).filter((entity) => entity.layout)
